...
function register_site_moderator_menus() {
  add_menu_page('Support', 'Support', 'manage_options', 'moderator_support_tickets', __NAMESPACE__ . '\\render_mod_page', 'dashicons-format-status');
}
add_action('admin_menu', __NAMESPACE__ . '\\register_site_moderator_menus');

function register_network_admin_menus() {
  add_menu_page('Support', 'Support', 'manage_options', 'admin_support_tickets', __NAMESPACE__ . '\\render_network_admin_page', 'dashicons-format-status');
}
add_action('network_admin_menu', __NAMESPACE__ . '\\register_network_admin_menus');

function render_mod_page() {
  echo 'Mod Page';
}
